...
/* USER CODE BEGIN 0 */
/*
unsigned char GetParityCheck(char* p, int len)
{
...
void Enrollment(UART_HandleTypeDef huart, uint32_t enrollment_pattern, uint8_t isAdm, uint32_t dir, char* name, char* id)
{
