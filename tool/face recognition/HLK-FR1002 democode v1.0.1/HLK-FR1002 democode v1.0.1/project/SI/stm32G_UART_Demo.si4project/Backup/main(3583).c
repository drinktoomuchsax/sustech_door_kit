...
void ML_API_DeleteID(UART_HandleTypeDef huart, uint8_t id)
{
...
void ML_API_DeleteAll(UART_HandleTypeDef huart) 
{
...
void ML_API_GetFirmwareVersion(UART_HandleTypeDef huart)
{
...
void ML_API_GetUUID(UART_HandleTypeDef huart)
{
...
int ML_API_Enrollment(UART_HandleTypeDef huart, P_USER p_user, uint8_t dir, uint8_t enrollment_pattern)
{
...
void ML_API_Match(UART_HandleTypeDef huart, P_USER p_user)
{
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  /*
  ML_API_GetFirmwareVersion(huart1);
	ML_API_GetUUID(huart1);
  */
 /*
  ML_API_DeleteAll(huart1);
   ML_API_DeleteID(huart1, 2);*/
  
/*   
  ML_API_Match(huart1, &user);
  */
  ...
  memcpy(user.name, name, 32);
	...
	{
		printf("pls look %s\n", str_dir[i]);
		int result = ML_API_Enrollment(huart1, &user, i, 1);
		if(result == 0)
		{
